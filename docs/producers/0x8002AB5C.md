...
runs: 342
prims_guest_max: 30434
prims_native_max: 60426
frames_seen: 30434
gte_calls_max: 0
has_native: false
...
native_hits: 0
oracle_hits: 0
name: field terrain pass
re_status: ported
re_evidence: codemap: NativeScenePass::terrainRender owns gen_func_8002AB5C, rebuilt PC-native with float matrices + real depth.
producer_file: game/render/native_terrain.cpp
compare_status: never-compared
notes: Only 700 prims in a 500-frame replay — measured 2026-08-11, refuting the assumption that terrain was the bulk of the WORLD layer's undeclared prims.
---
## What it is
