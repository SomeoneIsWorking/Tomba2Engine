...
`PSXPORT_GATE=1` sets `Game::psx_fallback=1`, and `override_registry.cpp`'s single dispatch decision
then runs the `gen` (recompiled) body for **every** registered address — measured 2026-08-06:
