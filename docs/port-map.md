...
- **notes:** OPENED 2026-08-06 by the G10 unported-render survey. UNRECORDED CONSEQUENCE of the tap retirement: mesh_emit_tap.cpp was the SINGLE owner of FUN_80027768 and dispatched to whichever controller SCOPE was up. Two of the 20 controller pictures now have display-pass owners: FUN_8002BC9C (the four-copy plume) and FUN_8002A834 (the weapon-charge starburst). The shared writer and eighteen controllers remain absent; tools/codemap.py --addr still answers NO NATIVE OWNER for 0x80027768, 0x800288AC (impact radial plume, kanban #15's 2026-07-23 fix), and the A00 overlay three 0x8013D828/0x8013ED08/0x8013EF58. 0x8013D454 keeps only its SPRITE branch (Render::waterJetSpriteRender); its MESH branch is gone — the 2026-07-28 A00 fix was gated at 700-1367 px/frame on walk-dust-puff.pad and that picture is now absent. MEASURED NEGATIVE CONTROL: PSXPORT_GATE=1 pc_render + PSXPORT_DEBUG=nofx,ringcensus on replays/bugs/bucket-softlock.pad, 460 frames headless, names 0x800288AC (node 800EEBF8) as live-and-skipped in area 0; 27 live type-0x20 nodes of 152 walked per frame. Falsifies claim C011. REAL FIX: one native producer per controller, reading the controller's OWN node state and projecting with the native camera — the shape fx_sprite.cpp/fx_dust.cpp/fx_line.cpp already use. The RE is largely DONE and must not be re-derived: kanban #15 (2026-07-28 entry) carries the full FUN_8002BC9C decode, and docs/findings/render.md 'The A00-overlay effect-mesh controllers' carries 0x8013D454/D828/ED08/EF58. Death condition: codemap --addr finds an owner for every controller in the 20-caller census in docs/findings/render.md.
