...
- **status:** todo
- **absent:** the PICTURE for these caller classes (a00-overlay flame/rope emitter, case-188 particles, B704 beams) was DELETED 2026-08-04, not left unported — its GTE-register tap is banned by PROTOCOL.md (USER, absolute). Rebuild ONLY as a native producer reading each emitter's own world state.
