...
Totals: 934 native fns, 787 owned addresses, 745 LIVE / 189 ORPHAN.
...
| 0x80027A4C | LIVE | `Render::fxSpriteRender` | game/render/fx_sprite.cpp:312 |  | The node's own render fn IS the emitter for every plain member of the … |
| 0x800286CC | LIVE | `Render::fxAnimSpriteRender` | game/render/fx_sprite.cpp:425 |  | The FUN_800286CC emitter, rebuilt: read the effect node's own animatio… |
...
| 0x8002AB5C | LIVE | `Render::terrain` | game/render/submit.cpp:477 |  | RETIRED 2026-07-07 (issue #32): Render::prepObjectMatrix (guest sway/I… |
...
| 0x800328EC | LIVE | `Render::altSpriteEmit` | game/render/fx_sprite.cpp:477 |  | ── FUN_800328EC family producers ─────────────────────────────────────… |
...
| 0x80033080 | LIVE | `Render::impactBurstRender` | game/render/fx_sprite.cpp:330 |  | the WEAPON-IMPACT burst (kanban #15), a COMPOSITE render fn: it is not… |
...
| 0x80039F4C | LIVE | `Render::textLabelEmit` | game/render/text_label.cpp:170 |  |  |
...
| 0x8003F174 | LIVE | `Render::subPartWalk` | game/render/subpart_walk.cpp:43 |  | ORACLE: gen_func_8003F174 |
...
| 0x800F2624 | LIVE | `Render::terrainRenderAll` | game/render/submit.cpp:494 |  | terrainRenderAll: the terrain-node enumeration (moved from render_walk… |
...
| 0x80109FE0 | LIVE | `Render::fieldEntityRender` | game/render/submit.cpp:425 |  | FIELD ENTITY RENDER LOOP — PC-native ownership of the SOP field-overla… |
...
| 0x8012D9E8 | LIVE | `Render::fxRotSpriteTailRender` | game/render/fx_sprite.cpp:552 |  | 's SPRITE TAIL. This controller is two emitters in one function: a lar… |
| 0x8012DA04 | LIVE | `beh_typed_anim_spawn` | game/ai/beh_typed_anim_spawn.cpp:45 |  |  |
| 0x8012E868 | LIVE | `Render::fxAltAnimSpriteRender` | game/render/fx_sprite.cpp:511 |  | (A01 overlay) — the animation-script member of the family. Same shape … |
...
| 0x8013D454 | LIVE | `Render::waterJetSpriteRender` | game/render/fx_sprite.cpp:529 |  | 's SPRITE branch — the water jet's other half. fx_mesh.cpp's scope own… |
