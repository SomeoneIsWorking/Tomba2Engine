...
| Tomba! 2 widescreen canvas behind an opaque full-screen 2D page | Cover the canvas an authored 4:3 page leaves showing, for every such page in the title | `game/render/wide_page_fill.*` | `tomba::render::WidePageFill::pushBehindPage` | `docs/kanban/cards/122-opaque-full-screen-2d-pages-keep-a-4-3-extent-in.md` |
