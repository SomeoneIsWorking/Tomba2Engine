...
**2026-08-12:** **CLOSED 2026-08-12 — fix (b) landed and is VERIFIED IN THIS TREE, both directions.** psxport daf4e026 added runtime/recomp/repl_service.{h,cpp} (refuse_if_unserviced); 6edea2c0 extended the guard to the DualCore and selftest loops, which the first commit left unguarded. Pinned here at 0a6c90f9.
