...
USER report 2026-07-17: RmlUi (vendored UI lib, external/psxport/vendor/rmlui; built via the former RmlUi build tool) not working. Symptom unspecified — need repro: build failure vs runtime (overlay not rendering / crash)? Investigate after READMEs.
