...
**2026-08-12:** 2026-08-12 FIXED (psxport 90604e18). Claim resolution: the guest leg now resolves its emitter frame outward to the frame a native producer keys a row at, bounded at 8 frames (otchain measured every claim within 3; a claim AT the limit is counted+warned). The claim set is persisted append-only across runs because NO SINGLE LEG runs both halves — pc_render never GP0-executes guest packets, psx_render never runs a native producer. Measured: leg1 earns 9 claims, leg2 joins 217533 spans / 145027 unclaimed (honest 'no native producer') / 1 too-early / 0 at limit. Guest rows now keyed at backdropRender/fieldEntityRender/tetherLineRender/terrainRender/cineBarsRender/menuItemsAndCursor. Folded DB: 8 rows carry BOTH legs, 27 guest-only. Residual: ~10% still keyed at SDK libgs builders (0x80080000/0x8008007C) whose chains contain no claim — filed separately.
