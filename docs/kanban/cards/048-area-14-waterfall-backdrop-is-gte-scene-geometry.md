...
EVIDENCE (measured, area reached with newgame; run 3000; warp 14; run 600):
  - bg-state selector mem_r8(0x800BF870) = 14. The field backdrop dispatcher (guest 0x8003DF04 @0x8003DF04) indexes its 16-entry jump table @0x80014FC0 at [14], which holds 0x8003E020 — the guest's OWN 'draw nothing' handler. So the backdrop dispatcher deliberately draws no tilemap in this area.
