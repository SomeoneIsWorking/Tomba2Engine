...
- **refs:** external/psxport/runtime/recomp/hle.cpp (heap_refused, dispatchBios `bios` channel) · docs/info/claims C045 · scratch/logs/gate-boot-20260812-211111.log
