...
// through typed runtime address dispatch in-context — see font.cpp for the full call chain.
//
...
public:
  ...
  //   the 3 engine leaves; dynamically dispatches the 8 libgpu/sound leaves in-order, in-context.
  ...
  //   guest instruction path did not set v0, so this doesn't either.
  ...
  //   scratchpad 0x1F800000..0x1F80001F; NOT ported here, only reached via typed runtime address dispatch, same as
  //   font.cpp's other KEPT libgpu/sound callees).
  //   Disas 0x80079374..0x800793C0 (tools/disas.py 0x80079374 --all 40) / guest 0x80079374
  ...
  //                                                  slot; confidence: CONFIRMED from the guest-visible behavior,
  ...
  //   (authenticated executable/overlay evidence, shard_6.c:13960/13987/14010/14031, shard_7.c:11935/12062/12102/
  ...
  //   mem_r32(r16+12)`), stack[+16]=color. `a3`/r7 is NEVER referenced inside guest 0x80079374's
  ...
  //                                                  from any argument)
  //     tail-calls FUN_80078CA8(a0', a1', a2', a3', color) via typed runtime address dispatch, ra = 0x800793B4
  ...
  //   fixed constants it feeds the emitter (confirmed byte-for-byte against guest 0x80079324,
  //   authenticated executable/overlay evidence, vs guest 0x80079374):
  ...
  //   this wave: guest 0x80078CA8 (authenticated executable/overlay evidence) has a REAL `return` at gen-C line 210
  ...
  //   file's history, e.g. channelEnvelopeRampTick's trailing guest 0x800922A0). The REAL body is ~180
  ...
  //     guest 0x80083DE0 (0x80083DE0, game/render/wide_re_libgpu_leaves.cpp — draw-mode/texwin packet-
  ...
  //   (direct re-read of the guest-visible behavior); individual field ROLES beyond what's stated above (esp.
