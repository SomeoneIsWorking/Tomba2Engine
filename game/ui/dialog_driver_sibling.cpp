...
static void ov_dialog_sibling(Core *c) {
  DialogDriver::siblingStep(c);
}
...
void dialog_sibling_install() {
  ...
  overrides::install(
      0x8007DDE0u, "DialogDriver::siblingStep", ov_dialog_sibling, gen_func_8007DDE0, shard_set_override);
}
