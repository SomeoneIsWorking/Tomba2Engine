...
public:
  ...
  static bool routePanelFill(Core* c, uint32_t rectPtr, int32_t uvIndex, uint16_t attr,
                             int32_t otBucket);
  static bool routePanelCorners(Core* c, uint32_t rectPtr, uint16_t style, uint32_t shadow,
                                int32_t otBucket);
