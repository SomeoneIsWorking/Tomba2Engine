...
L_8007C140:;
  ...
  {
    int _t = (c->r[2] != c->r[0]);
    c->r[2] = (uint32_t)((int32_t)c->r[3] < 248);
    if (_t) {
      goto L_8007C168;
    }
  }
...
L_8007C168:;
  {
    int _t = (c->r[2] == c->r[0]);
    c->r[2] = (uint32_t)((int32_t)c->r[3] < 209);
    if (_t) {
      goto L_8007C1A4;
    }
  }
  {
    int _t = (c->r[2] == c->r[0]);
    c->r[2] = (uint32_t)((int32_t)c->r[3] < 192);
    if (_t) {
      goto L_8007C24C;
    }
  }
...
L_8007C214:;
  ...
  c->mem_w8((c->r[16] + (uint32_t)42), (uint8_t)c->r[4]);
  goto L_8007C290;
L_8007C228:;
  {
    int _t = (c->r[17] != c->r[5]);
  ...
  c->mem_w8((c->r[16] + (uint32_t)5), (uint8_t)c->r[17]);
  c->r[4] = c->r[4] + c->r[2];
  c->mem_w32((c->r[16] + (uint32_t)20), c->r[4]);
  goto L_8007C290;
L_8007C24C:;
