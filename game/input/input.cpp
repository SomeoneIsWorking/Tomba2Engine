...
void Input::setVoiceVolume(Core* c) {
  ...
  L_80092E98:;
    ...
    c->r[2] = c->r[4] & 65535u;
    c->r[2] = (uint32_t)(c->r[2] < (uint32_t)24);
    { int _t = (c->r[2] != c->r[0]); c->mem_w32((c->r[29] + (uint32_t)32), c->r[31]); if (_t) goto L_80092ECC; }
    c->r[2] = c->r[0] + (uint32_t)-1; goto L_80092F38;
  L_80092ECC:;
    c->r[4] = c->r[4] << 16;
    c->r[4] = (uint32_t)((int32_t)c->r[4] >> 16);
    c->r[5] = c->r[29] + (uint32_t)16;
    c->r[31] = 0x80092EE0u;
    c->r[6] = c->r[29] + (uint32_t)18; func_8009A170(c);
    c->r[5] = (uint32_t)4064u << 16;
    c->r[3] = (uint32_t)c->mem_r16((c->r[29] + (uint32_t)16));
    c->r[5] = c->r[5] | 16257u;
    c->r[3] = c->r[3] << 16;
    c->r[2] = (uint32_t)((int32_t)c->r[3] >> 16);
    ...
    c->r[4] = (uint32_t)c->mem_r16((c->r[29] + (uint32_t)18));
    c->r[4] = c->r[4] << 16;
    c->r[2] = (uint32_t)((int32_t)c->r[4] >> 16);
    { int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[5]; c->lo = (uint32_t)_p; c->hi = (uint32_t)((uint64_t)_p >> 32); }
    c->r[2] = c->r[0] + c->r[0];
    c->r[4] = (uint32_t)((int32_t)c->r[4] >> 31);
    c->r[7] = c->hi;
    c->r[3] = (uint32_t)((int32_t)c->r[7] >> 3);
    c->r[3] = c->r[3] - c->r[4];
    c->mem_w16((c->r[17] + (uint32_t)0), (uint16_t)c->r[3]);
  L_80092F38:;
    ...
    c->r[2] = c->r[7] & 65535u;
    c->r[2] = (uint32_t)(c->r[2] < (uint32_t)24);
    { int _t = (c->r[2] != c->r[0]); c->r[2] = c->r[0] + c->r[0]; if (_t) goto L_80092F68; }
    c->r[2] = c->r[0] + (uint32_t)-1; goto L_80092FC8;
  L_80092F68:;
    c->r[3] = c->r[6] << 16;
    c->r[3] = (uint32_t)((int32_t)c->r[3] >> 16);
    c->r[4] = c->r[3] << 7;
    ...
    c->r[1] = (uint32_t)32784u << 16;
    c->r[1] = c->r[1] + c->r[7];
    c->mem_w16((c->r[1] + (uint32_t)23082), (uint16_t)c->r[4]);
    c->r[4] = c->r[5] << 16;
    c->r[4] = (uint32_t)((int32_t)c->r[4] >> 16);
    c->r[3] = c->r[4] << 7;
    c->r[5] = (uint32_t)32784u << 16;
    c->r[5] = c->r[5] + c->r[6];
    c->r[5] = (uint32_t)c->mem_r8((c->r[5] + (uint32_t)23048));
    c->r[3] = c->r[3] + c->r[4];
    c->r[1] = (uint32_t)32784u << 16;
    c->r[1] = c->r[1] + c->r[7];
    c->mem_w16((c->r[1] + (uint32_t)23080), (uint16_t)c->r[3]);
    c->r[5] = c->r[5] | 3u;
    c->r[1] = (uint32_t)32784u << 16;
    c->r[1] = c->r[1] + c->r[6];
    c->mem_w8((c->r[1] + (uint32_t)23048), (uint8_t)c->r[5]);
  L_80092FC8:;
     return;
    return;
}
