...
void PadSampler::sampleButtonMask(Core* c) {
    ...
    { int _t = (c->r[3] == c->r[0]); c->mem_w32((c->r[29] + (uint32_t)16), c->r[16]); if (_t) goto L_800524F4; }
    c->r[2] = c->r[0] + c->r[0]; goto L_800525B0;
  L_800524F4:;
    c->r[4] = c->r[0] + c->r[0];
    c->r[5] = c->r[0] + (uint32_t)2;
    c->r[31] = 0x80052504u;
    c->r[6] = c->r[4] + c->r[0]; func_80087BB8(c);
    ...
    { int _t = (c->r[4] == c->r[2]); c->r[16] = c->r[3] + c->r[0]; if (_t) goto L_80052544; }
    c->r[2] = c->r[0] + (uint32_t)7;
    { int _t = (c->r[4] == c->r[2]); c->r[2] = c->r[0] + c->r[0]; if (_t) goto L_80052550; }
     goto L_800525B0;
  L_80052544:;
    c->mem_w8((c->r[17] + (uint32_t)8), (uint8_t)c->r[0]);
    c->mem_w8((c->r[17] + (uint32_t)9), (uint8_t)c->r[0]); goto L_800525A8;
  L_80052550:;
    c->r[2] = c->r[19] << 16;
    { int _t = (c->r[2] != c->r[0]); c->r[2] = c->r[16] << 16; if (_t) goto L_800525AC; }
    c->r[2] = c->r[3] & 240u;
    { int _t = (c->r[2] != c->r[0]); c->r[5] = c->r[0] + c->r[0]; if (_t) goto L_80052588; }
    c->r[4] = (uint32_t)c->mem_r8((c->r[18] + (uint32_t)6));
    c->r[31] = 0x80052574u;
    c->r[16] = c->r[3] & 65295u; func_80052144(c);
    c->r[5] = c->r[0] + (uint32_t)1;
    c->r[4] = (uint32_t)c->mem_r8((c->r[18] + (uint32_t)7));
    c->r[31] = 0x80052584u;
    c->r[16] = c->r[16] | c->r[2]; func_80052144(c);
    c->r[16] = c->r[16] | c->r[2];
  L_80052588:;
    c->r[4] = (uint32_t)c->mem_r8((c->r[18] + (uint32_t)6));
    c->r[31] = 0x80052594u;
    c->r[5] = c->r[17] + (uint32_t)10; func_80052198(c);
    c->r[4] = (uint32_t)c->mem_r8((c->r[18] + (uint32_t)7));
    c->r[5] = c->r[17] + (uint32_t)11;
    c->r[31] = 0x800525A4u;
    c->mem_w8((c->r[17] + (uint32_t)8), (uint8_t)c->r[2]); func_80052198(c);
