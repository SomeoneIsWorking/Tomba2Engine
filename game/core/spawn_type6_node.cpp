...
namespace {
void ov_spawnType6Node(Core *c) {
  eng(c).spawnType6Node();
}
} // namespace
void Engine::registerSpawnType6Node() {
  overrides::install(0x800310F4u, "Engine::spawnType6Node", ov_spawnType6Node, gen_func_800310F4, shard_set_override);
}
