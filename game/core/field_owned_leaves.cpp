...
L_800249F0:;
  ...
  {
    int _t = (c->r[3] != c->r[4]);
    c->mem_w8((c->r[20] + (uint32_t)386), (uint8_t)c->r[2]);
    if (_t) {
      goto L_80024ABC;
    }
  }
...
static void leaf_80024F18(Core *c) {
  ...
  c->mem_w8((c->r[2] + (uint32_t)-12191), (uint8_t)c->r[0]);
  goto L_80024F98;
L_80024F68:;
...
L_80024FD4:;
  c->mem_w8((c->r[16] + (uint32_t)1), (uint8_t)c->r[0]);
  goto L_80024FE0;
L_80024FDC:;
...
L_80024FE0:;
  ...
  c->mem_w8((c->r[16] + (uint32_t)10), (uint8_t)c->r[2]);
  goto L_80025000;
L_80024FFC:;
...
L_80025154:;
  ...
  c->mem_w8((c->r[2] + (uint32_t)-2016), (uint8_t)c->r[0]);
  goto L_800251E0;
L_8002516C:;
  c->r[2] = (uint32_t)c->mem_r8((c->r[16] + (uint32_t)4));
  {
...
static void leaf_8002AE0C(Core *c) {
  ...
  {
    int _t = (c->r[6] != c->r[0]);
    c->mem_w8((c->r[17] + (uint32_t)1), (uint8_t)c->r[2]);
    if (_t) {
      goto L_8002B000;
    }
  }
  ...
  c->r[31] = 0x8002AEACu;
  c->mem_w16((c->r[29] + (uint32_t)20), (uint16_t)c->r[3]);
  func_80085480(c);
  c->r[4] = c->r[16] + c->r[0];
  ...
  c->r[31] = 0x8002AEDCu;
  c->mem_w32((c->r[29] + (uint32_t)32), c->r[3]);
  func_80084520(c);
...
L_80031814:;
  ...
  c->r[3] = c->mem_r32((c->r[5] + (uint32_t)128));
  {
    ...
    c->r[3] = (uint32_t)((int32_t)c->r[3] >> 2);
    if (_t) {
      goto L_8003180C;
    }
  }
...
static void leaf_80033AFC(Core *c) {
  ...
  c->r[3] = c->r[0] + (uint32_t)119;
  goto L_80033B44;
L_80033B34:;
  c->r[3] = c->r[0] + (uint32_t)117;
  goto L_80033B40;
L_80033B3C:;
...
L_8003A2E4:;
  c->r[5] = c->r[16] + c->r[0];
  c->r[31] = 0x8003A2F0u;
  c->mem_w8((c->r[16] + (uint32_t)62), (uint8_t)c->r[6]);
  func_8003A1E4(c);
...
L_8003A338:;
  ...
  c->r[3] = c->r[3] + (uint32_t)1;
  c->mem_w8((c->r[16] + (uint32_t)62), (uint8_t)c->r[3]);
  goto L_8003A3D4;
L_8003A3B4:;
...
L_8003A418:;
  c->r[5] = c->r[16] + c->r[0];
  c->r[31] = 0x8003A424u;
  c->mem_w8((c->r[16] + (uint32_t)62), (uint8_t)c->r[2]);
  func_8003A1E4(c);
  c->r[31] = 0x8003A42Cu;
  c->mem_w16((c->r[16] + (uint32_t)0), (uint16_t)c->r[2]);
  func_8009A450(c);
...
L_8003A544:;
  c->r[2] = c->lo;
  c->mem_w16((c->r[16] + (uint32_t)56), (uint16_t)c->r[2]);
  goto L_8003A5D0;
L_8003A550:;
  c->r[2] = (uint32_t)c->mem_r16((c->r[16] + (uint32_t)18));
...
L_8003A678:;
  ...
  {
    int _t = (c->r[2] != c->r[0]);
    c->mem_w16((c->r[5] + (uint32_t)2), (uint16_t)c->r[3]);
    if (_t) {
      goto L_8003A788;
    }
  }
...
L_8003A824:;
  ...
  c->mem_w16((c->r[18] + (uint32_t)54), (uint16_t)c->r[2]);
  c->r[2] = c->r[0] + (uint32_t)1;
  c->mem_w8((c->r[18] + (uint32_t)94), (uint8_t)c->r[2]);
  goto L_8003A988;
L_8003A864:;
  c->r[16] = c->r[0] + c->r[0];
...
static void leaf_8003B588(Core *c) {
  ...
  {
    int _t = (c->r[2] != c->r[0]);
    c->mem_w8((c->r[16] + (uint32_t)13), (uint8_t)c->r[3]);
    if (_t) {
      goto L_8003B69C;
    }
  }
...
L_8003B68C:;
  ...
  c->mem_w8((c->r[16] + (uint32_t)26), (uint8_t)c->r[2]);
  goto L_8003B69C;
L_8003B698:;
...
static void leaf_8003E030(Core *c) {
  ...
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[17];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  ...
  c->r[9] = c->lo;
  c->r[31] = 0x8003E0A8u;
  c->r[17] = (uint32_t)((int32_t)c->r[9] >> 8);
  func_80083F50(c);
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[17];
    c->lo = (uint32_t)_p;
  ...
  c->r[3] = c->lo;
  c->r[31] = 0x8003E100u;
  c->r[30] = (uint32_t)((int32_t)c->r[3] >> 18);
  func_80083DB0(c);
...
static void leaf_8003E448(Core *c) {
  ...
  c->r[4] = c->r[4] + c->r[3];
  {
    int64_t _p = (int64_t)(int32_t)c->r[4] * (int64_t)(int32_t)c->r[19];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  ...
  c->r[6] = c->lo;
  {
    int64_t _p = (int64_t)(int32_t)c->r[3] * (int64_t)(int32_t)c->r[19];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  c->r[2] = c->r[7] + c->r[5];
  ...
  c->r[4] = c->r[4] + c->r[3];
  {
    int64_t _p = (int64_t)(int32_t)c->r[4] * (int64_t)(int32_t)c->r[18];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  ...
  c->r[4] = c->lo;
  {
    int64_t _p = (int64_t)(int32_t)c->r[3] * (int64_t)(int32_t)c->r[18];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
...
static void leaf_8003E894(Core *c) {
  ...
  c->r[3] = c->r[3] + c->r[2];
  c->r[31] = 0x8003E930u;
  c->mem_w16((c->r[16] + (uint32_t)140), (uint16_t)c->r[3]);
  func_80083E80(c);
  ...
  c->r[31] = 0x8003E964u;
  c->mem_w32((c->r[17] + (uint32_t)15128), c->r[6]);
  func_80083DB0(c);
...
L_8003E9B0:;
  ...
  c->r[31] = 0x8003E9C8u;
  c->mem_w16((c->r[29] + (uint32_t)38), (uint16_t)c->r[21]);
  func_8003E448(c);
...
L_8003EB0C:;
  ...
  c->r[3] = c->r[3] + c->r[2];
  c->r[3] = c->r[3] & 255u;
  c->mem_w32((c->r[12] + (uint32_t)140), c->r[3]);
  return;
  return;
}
...
static void leaf_8003EBE0(Core *c) {
  ...
  c->r[2] = c->r[0] + (uint32_t)1;
  c->mem_w32((c->r[4] + (uint32_t)152), c->r[2]);
  goto L_8003EC60;
L_8003EC4C:;
  c->r[2] = c->mem_r32((c->r[3] + (uint32_t)148));
  {
...
L_8003EC64:;
  ...
  {
    int _t = (c->r[2] != c->r[0]);
    c->mem_w32((c->r[4] + (uint32_t)140), c->r[3]);
    if (_t) {
      goto L_8003EC88;
    }
  }
  c->r[2] = c->r[0] + (uint32_t)255;
  c->mem_w32((c->r[4] + (uint32_t)140), c->r[2]);
  goto L_8003EC94;
L_8003EC88:;
  {
    int _t = ((int32_t)c->r[3] >= 0);
...
L_8003EC98:;
  ...
  {
    int _t = (c->r[4] != c->r[0]);
    c->mem_w32((c->r[2] + (uint32_t)144), c->r[3]);
    if (_t) {
      goto L_8003ECC8;
    }
  }
  ...
  c->mem_w8((c->r[2] + (uint32_t)15116), (uint8_t)c->r[0]);
  goto L_8003ECCC;
L_8003ECC8:;
...
static void leaf_8003FB84(Core *c) {
  c->r[3] = (uint32_t)8064u << 16;
  c->r[2] = c->r[0] + (uint32_t)255;
  c->mem_w32((c->r[3] + (uint32_t)140), c->r[2]);
  return;
  return;
}
...
static void leaf_8003FB94(Core *c) {
  ...
  c->r[2] = c->r[0] + (uint32_t)2;
  c->mem_w8((c->r[3] + (uint32_t)15116), (uint8_t)c->r[2]);
  return;
  return;
}
...
static void leaf_8003FC8C(Core *c) {
  ...
  c->r[2] = c->r[0] + (uint32_t)1;
  c->mem_w16((c->r[16] + (uint32_t)50), (uint16_t)c->r[3]);
  goto L_8003FCFC;
L_8003FCF8:;
  c->r[2] = c->r[0] + c->r[0];
L_8003FCFC:;
...
L_8003FE38:;
  ...
  goto L_8003FE74;
L_8003FE50:;
  c->r[5] = c->r[0] + (uint32_t)29;
  goto L_8003FE6C;
L_8003FE58:;
  c->r[5] = c->r[0] + (uint32_t)30;
  goto L_8003FE6C;
L_8003FE60:;
  c->r[5] = c->r[0] + (uint32_t)31;
  goto L_8003FE6C;
L_8003FE68:;
...
static void leaf_80044CD4(Core *c) {
  ...
  c->r[2] = c->r[2] + c->r[19];
  {
    ...
    c->mem_w32((c->r[3] + (uint32_t)496), c->r[2]);
    if (_t) {
      goto L_80044D48;
    }
  }
...
static void leaf_80045CAC(Core *c) {
  ...
  c->mem_w32((c->r[29] + (uint32_t)48), c->r[16]);
  c->r[31] = 0x80045CF8u;
  c->mem_w16((c->r[29] + (uint32_t)16), (uint16_t)c->r[7]);
  func_80083E80(c);
  c->r[2] = c->r[0] - c->r[2];
  c->r[16] = c->r[19] << 16;
  c->r[16] = (uint32_t)((int32_t)c->r[16] >> 16);
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[16];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  ...
  c->r[8] = c->lo;
  c->r[31] = 0x80045D24u;
  c->r[18] = (uint32_t)((int32_t)c->r[8] >> 12);
  func_80083F50(c);
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[16];
    c->lo = (uint32_t)_p;
...
L_80045D64:;
  ...
  c->r[8] = (uint32_t)8064u << 16;
  c->r[31] = 0x80045D88u;
  c->mem_w16((c->r[8] + (uint32_t)448), (uint16_t)c->r[3]);
  func_800498C8(c);
  {
    int _t = (c->r[2] == c->r[0]);
    c->r[2] = (uint32_t)8064u << 16;
...
L_80045EC8:;
  ...
  c->r[8] = c->lo;
  c->r[31] = 0x80045F0Cu;
  c->r[20] = (uint32_t)((int32_t)c->r[8] >> 12);
  func_80083E80(c);
  c->r[2] = c->r[0] - c->r[2];
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[16];
...
L_80046934:;
  ...
  c->r[31] = 0x80046954u;
  c->mem_w16((c->r[21] + (uint32_t)448), (uint16_t)c->r[3]);
  func_800498C8(c);
  {
    int _t = (c->r[2] != c->r[0]);
    c->r[2] = (uint32_t)8064u << 16;
...
L_80047858:;
  ...
  c->mem_w16((c->r[7] + (uint32_t)444), (uint16_t)c->r[3]);
  goto L_800478B8;
L_8004789C:;
...
L_800478B8:;
  ...
  c->r[2] = c->r[2] - c->r[3];
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[4];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  c->r[4] = (uint32_t)8064u << 16;
  ...
  c->r[2] = c->r[2] + c->r[3];
  c->mem_w16((c->r[4] + (uint32_t)448), (uint16_t)c->r[2]);
  goto L_80047974;
L_800478F8:;
  c->r[3] = (uint32_t)8064u << 16;
  ...
  c->mem_w16((c->r[7] + (uint32_t)448), (uint16_t)c->r[3]);
  goto L_80047938;
L_8004791C:;
...
L_80047BA0:;
  ...
  c->r[3] = c->r[3] & c->r[7];
  c->mem_w16((c->r[4] + (uint32_t)424), (uint16_t)c->r[3]);
  goto L_80047CAC;
L_80047C10:;
  c->r[3] = (uint32_t)8064u << 16;
  ...
  {
    int _t = (c->r[3] == c->r[0]);
    c->mem_w16((c->r[4] + (uint32_t)416), (uint16_t)c->r[5]);
    if (_t) {
      goto L_80047C7C;
    }
  }
  c->r[2] = (uint32_t)8064u << 16;
  c->mem_w16((c->r[2] + (uint32_t)418), (uint16_t)c->r[5]);
  goto L_80047C8C;
L_80047C7C:;
  c->r[3] = (uint32_t)8064u << 16;
...
L_80048A88:;
  ...
  func_80085690(c);
  {
    int64_t _p = (int64_t)(int32_t)c->r[16] * (int64_t)(int32_t)c->r[16];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  c->r[4] = c->lo;
  {
    int64_t _p = (int64_t)(int32_t)c->r[18] * (int64_t)(int32_t)c->r[18];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  c->r[3] = (uint32_t)8064u << 16;
...
L_80048BB0:;
  ...
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[9];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  c->r[2] = (uint32_t)c->mem_r16((c->r[4] + (uint32_t)2));
  c->r[15] = c->lo;
  c->r[3] = (uint32_t)((int32_t)c->r[15] >> 6);
  goto L_80048C44;
L_80048BFC:;
  c->r[2] = (uint32_t)(int16_t)c->mem_r16((c->r[4] + (uint32_t)4));
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[11];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  c->r[3] = c->lo;
...
L_80048C44:;
  ...
  c->mem_w16((c->r[5] + (uint32_t)420), (uint16_t)c->r[17]);
  goto L_80048D28;
L_80048C80:;
  c->r[17] = c->r[2] + c->r[0];
...
L_80048CDC:;
  ...
  c->r[3] = c->r[3] + c->r[5];
  c->r[4] = c->r[4] + c->r[3];
  c->mem_w32((c->r[6] + (uint32_t)488), c->r[4]);
  goto L_80048D28;
L_80048D18:;
  c->r[3] = (uint32_t)8064u << 16;
...
L_80048F78:;
  ...
  c->r[2] = c->r[4] - c->r[5];
  c->mem_w16((c->r[3] + (uint32_t)432), (uint16_t)c->r[2]);
  return;
L_80048FB0:;
  c->r[3] = (uint32_t)8064u << 16;
...
static void leaf_80048FC4(Core *c) {
  ...
  c->r[4] = c->r[8] - c->r[4];
  {
    int64_t _p = (int64_t)(int32_t)c->r[4] * (int64_t)(int32_t)c->r[4];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  c->r[2] = (uint32_t)8064u << 16;
...
L_80049084:;
  ...
  c->mem_w16((c->r[9] + (uint32_t)448), (uint16_t)c->r[10]);
  goto L_800490D4;
L_80049094:;
  c->r[3] = (uint32_t)8064u << 16;
...
static void leaf_80049674(Core *c) {
  ...
  c->r[4] = c->lo;
  {
    int64_t _p = (int64_t)(int32_t)c->r[17] * (int64_t)(int32_t)c->r[17];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  c->r[3] = (uint32_t)8064u << 16;
...
L_80049FB0:;
  ...
  c->r[2] = c->r[2] + (uint32_t)1;
  c->mem_w8((c->r[5] + (uint32_t)13), (uint8_t)c->r[2]);
  goto L_8004A000;
L_80049FDC:;
...
L_8004A098:;
  ...
  c->r[2] = c->r[0] + (uint32_t)1;
  c->r[3] = c->r[3] & 253u;
  c->mem_w8((c->r[4] + (uint32_t)9), (uint8_t)c->r[3]);
  goto L_8004A108;
L_8004A0B0:;
  {
    int _t = ((int32_t)c->r[3] > 0);
...
L_8004A0C4:;
  ...
  c->mem_w16((c->r[7] + (uint32_t)366), (uint16_t)c->r[3]);
  goto L_8004A104;
L_8004A100:;
  c->mem_w16((c->r[4] + (uint32_t)64), (uint16_t)c->r[2]);
L_8004A104:;
...
L_8004B484:;
  ...
  c->r[31] = 0x8004B518u;
  c->mem_w8((c->r[4] + (uint32_t)109), (uint8_t)c->r[16]);
  func_80067DA8(c);
  c->r[31] = c->mem_r32((c->r[29] + (uint32_t)20));
  c->r[16] = c->mem_r32((c->r[29] + (uint32_t)16));
  c->r[29] = c->r[29] + (uint32_t)24;
...
L_8004C180:;
  ...
  c->r[31] = 0x8004C18Cu;
  c->r[7] = c->r[0] + (uint32_t)4;
  func_80072DDC(c);
  c->r[4] = c->r[2] + c->r[0];
  {
    int _t = (c->r[4] != c->r[0]);
    c->r[2] = (uint32_t)32773u << 16;
    if (_t) {
      goto L_8004C1A0;
    }
  }
...
L_8004C1A0:;
  ...
  {
    int _t = (c->r[19] == c->r[0]);
    c->mem_w16((c->r[4] + (uint32_t)98), (uint16_t)c->r[3]);
    if (_t) {
      goto L_8004C1E4;
    }
  }
...
static void leaf_8004D650(Core *c) {
  ...
  c->r[2] = c->r[2] - c->r[5];
  c->r[31] = 0x8004D678u;
  c->mem_w8((c->r[3] + (uint32_t)580), (uint8_t)c->r[2]);
  func_8004D514(c);
  c->r[31] = c->mem_r32((c->r[29] + (uint32_t)16));
  c->r[29] = c->r[29] + (uint32_t)24;
  return;
...
L_8004D724:;
  ...
  c->r[3] = c->r[3] | c->r[2];
  c->mem_w8((c->r[5] + (uint32_t)1092), (uint8_t)c->r[3]);
  return;
L_8004D76C:;
  c->r[2] = c->r[2] + (uint32_t)-1936;
  c->r[5] = c->r[5] << 16;
  ...
  c->r[2] = c->r[2] << (c->r[4] & 31);
  c->r[3] = c->r[3] | c->r[2];
  c->mem_w8((c->r[5] + (uint32_t)1220), (uint8_t)c->r[3]);
  return;
  return;
}
...
L_8004D7AC:;
  ...
  c->r[2] = c->r[2] << (c->r[4] & 31);
  c->r[3] = c->r[3] | c->r[2];
  c->mem_w8((c->r[5] + (uint32_t)1348), (uint8_t)c->r[3]);
  return;
  return;
}
...
static void leaf_8004DAEC(Core *c) {
  ...
  c->r[2] = c->r[2] + c->r[3];
  c->r[31] = 0x8004DB80u;
  c->mem_w16((c->r[19] + (uint32_t)54), (uint16_t)c->r[2]);
  func_8007778C(c);
  c->r[31] = 0x8004DB88u;
  c->r[4] = c->r[19] + c->r[0];
  func_80077B5C(c);
...
static void leaf_8004ED0C(Core *c) {
  ...
  {
    int _t = (c->r[5] == c->r[2]);
    c->mem_w16((c->r[29] + (uint32_t)16), (uint16_t)c->r[4]);
    if (_t) {
      goto L_8004ED74;
    }
  }
...
L_8004F5B0:;
  ...
  c->mem_w16((c->r[16] + (uint32_t)1), (uint16_t)c->r[3]);
  goto L_8004F688;
L_8004F5E8:;
  c->r[2] = (uint32_t)c->mem_r8((c->r[16] + (uint32_t)-2));
...
L_8004F880:;
  ...
  c->mem_w8((c->r[19] + (uint32_t)1), (uint8_t)c->r[0]);
  goto L_8004F8B8;
L_8004F894:;
...
static void leaf_80050894(Core *c) {
  ...
  c->mem_w8((c->r[2] + (uint32_t)8236), (uint8_t)c->r[4]);
  return;
  return;
}
...
static void leaf_8005245C(Core *c) {
  ...
  c->r[31] = 0x80052484u;
  c->mem_w8((c->r[2] + (uint32_t)5), (uint8_t)c->r[0]);
  func_80087EAC(c);
  c->r[31] = 0x8005248Cu;
  c->r[4] = c->r[0] + c->r[0];
  func_80087AEC(c);
...
static void leaf_80052720(Core *c) {
  ...
  c->r[7] = c->lo;
  c->r[31] = 0x80052784u;
  c->r[17] = (uint32_t)((int32_t)c->r[7] >> 4);
  func_80083E80(c);
  c->r[3] = (uint32_t)(int16_t)c->mem_r16((c->r[16] + (uint32_t)68));
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[3];
...
static void leaf_80053D0C(Core *c) {
  ...
  {
    int _t = (c->r[3] == c->r[2]);
    c->r[2] = (uint32_t)((int32_t)c->r[3] < 5);
    if (_t) {
      goto L_80053D68;
    }
  }
...
L_80053D60:;
  c->mem_w8((c->r[5] + (uint32_t)94), (uint8_t)c->r[0]);
  goto L_80053D84;
L_80053D68:;
...
L_80053DCC:;
  ...
  c->mem_w8((c->r[5] + (uint32_t)40), (uint8_t)c->r[2]);
  goto L_80053E30;
L_80053E00:;
  c->r[5] = c->mem_r32((c->r[4] + (uint32_t)16));
  c->r[2] = c->r[0] + (uint32_t)2;
...
L_80053E30:;
  ...
  c->r[31] = 0x80053E40u;
  c->mem_w8((c->r[4] + (uint32_t)385), (uint8_t)c->r[0]);
  func_80053D0C(c);
  c->r[31] = c->mem_r32((c->r[29] + (uint32_t)16));
  c->r[29] = c->r[29] + (uint32_t)24;
  return;
...
L_8005459C:;
  ...
  {
    int _t = (c->r[19] != c->r[2]);
    c->mem_w16((c->r[16] + (uint32_t)106), (uint16_t)c->r[3]);
    if (_t) {
      goto L_800545E0;
    }
  }
...
L_800545E0:;
  ...
  c->mem_w16((c->r[16] + (uint32_t)364), (uint16_t)c->r[2]);
  goto L_80054618;
L_80054614:;
  c->mem_w16((c->r[16] + (uint32_t)364), (uint16_t)c->r[0]);
L_80054618:;
...
L_8005514C:;
  ...
  c->r[5] = c->r[5] + c->r[2];
  c->r[31] = 0x8005517Cu;
  c->mem_w32((c->r[17] + (uint32_t)56), c->r[5]);
  func_80077E3C(c);
  c->mem_w8((c->r[17] + (uint32_t)70), (uint8_t)c->r[16]);
  goto L_800551A4;
L_80055184:;
...
static void leaf_800551C4(Core *c) {
  ...
  c->r[2] = c->r[2] - c->r[3];
  c->r[2] = c->r[2] & 4095u;
  c->mem_w16((c->r[4] + (uint32_t)88), (uint16_t)c->r[2]);
  return;
L_8005521C:;
  c->r[2] = (uint32_t)c->mem_r16((c->r[4] + (uint32_t)320));
  c->r[3] = (uint32_t)c->mem_r8((c->r[4] + (uint32_t)325));
...
static void leaf_80055E28(Core *c) {
  ...
  c->mem_w8((c->r[16] + (uint32_t)330), (uint8_t)c->r[0]);
  goto L_80055E94;
L_80055E7C:;
...
L_80055E94:;
  ...
  c->mem_w8((c->r[16] + (uint32_t)331), (uint8_t)c->r[2]);
  goto L_80055ECC;
L_80055EB8:;
  c->mem_w8((c->r[16] + (uint32_t)331), (uint8_t)c->r[2]);
  goto L_80055ECC;
...
L_80055FEC:;
  ...
  c->r[2] = c->r[2] & 3840u;
  c->r[2] = c->r[2] ^ 1280u;
  c->r[13] = (uint32_t)(c->r[2] < (uint32_t)1);
  goto L_8005602C;
L_80056028:;
  c->r[13] = c->r[0] + c->r[0];
L_8005602C:;
...
L_800561BC:;
  ...
  {
    int _t = (c->r[2] != c->r[0]);
    c->mem_w8((c->r[4] + (uint32_t)329), (uint8_t)c->r[0]);
    if (_t) {
      goto L_8005620C;
    }
  }
...
L_80056308:;
  ...
  c->mem_w16((c->r[4] + (uint32_t)68), (uint16_t)c->r[10]);
  goto L_80056290;
L_8005633C:;
  ...
  c->mem_w16((c->r[4] + (uint32_t)68), (uint16_t)c->r[9]);
  goto L_80056290;
L_80056364:;
...
L_800564C4:;
  ...
  {
    int _t = (c->r[2] != c->r[0]);
    c->mem_w8((c->r[4] + (uint32_t)329), (uint8_t)c->r[3]);
    if (_t) {
      goto L_80056514;
    }
  }
...
L_80056CAC:;
  ...
  {
    int _t = (c->r[5] != c->r[0]);
    c->mem_w8((c->r[16] + (uint32_t)328), (uint8_t)c->r[2]);
    if (_t) {
      goto L_80056D20;
    }
  }
...
static void leaf_80056F3C(Core *c) {
  ...
  {
    int _t = ((int32_t)c->r[4] >= 0);
    c->r[2] = (uint32_t)((int32_t)c->r[4] < 7);
    if (_t) {
      goto L_80056FC4;
    }
  }
  ...
  c->mem_w8((c->r[7] + (uint32_t)377), (uint8_t)c->r[0]);
  goto L_80056F90;
L_80056F8C:;
...
L_800573A8:;
  ...
  {
    int _t = (c->r[2] == c->r[0]);
    c->r[2] = (uint32_t)(c->r[3] < (uint32_t)255);
    if (_t) {
      goto L_800573D0;
    }
  }
...
L_800574B0:;
  ...
  c->r[3] = c->r[3] + (uint32_t)1;
  c->mem_w8((c->r[4] + (uint32_t)7), (uint8_t)c->r[3]);
  return;
  return;
}
...
L_800576C8:;
  c->r[2] = c->r[0] + (uint32_t)2;
  c->mem_w8((c->r[16] + (uint32_t)7), (uint8_t)c->r[2]);
  c->mem_w8((c->r[16] + (uint32_t)325), (uint8_t)c->r[2]);
  goto L_80057A50;
L_800576D8:;
  {
    int _t = (c->r[2] == c->r[0]);
...
L_80057908:;
  ...
  c->mem_w8((c->r[4] + (uint32_t)7), (uint8_t)c->r[0]);
  c->r[31] = 0x80057920u;
  c->mem_w8((c->r[4] + (uint32_t)325), (uint8_t)c->r[7]);
  func_80054D14(c);
  c->r[4] = c->r[0] + (uint32_t)29;
  c->r[5] = c->r[0] + c->r[0];
  c->r[31] = 0x80057930u;
...
static void leaf_80057A68(Core *c) {
  ...
  {
    int _t = (c->r[2] == c->r[0]);
    c->mem_w32((c->r[16] + (uint32_t)344), c->r[2]);
    if (_t) {
      goto L_80057BF4;
    }
  }
...
L_80057B20:;
  ...
  c->mem_w8((c->r[16] + (uint32_t)6), (uint8_t)c->r[3]);
  c->r[2] = c->r[2] & 1u;
  c->mem_w8((c->r[16] + (uint32_t)356), (uint8_t)c->r[2]);
  goto L_80057BE4;
L_80057B88:;
  c->r[4] = c->r[0] + (uint32_t)5;
L_80057B8C:;
...
static void leaf_80059C60(Core *c) {
  ...
  {
    int _t = (c->r[4] == c->r[0]);
    c->mem_w8((c->r[3] + (uint32_t)583), (uint8_t)c->r[2]);
    if (_t) {
      goto L_80059CA8;
    }
  }
...
L_8005A7E8:;
  ...
  {
    int _t = (c->r[3] == c->r[2]);
    c->r[2] = (uint32_t)((int32_t)c->r[3] < 11);
    if (_t) {
      goto L_8005A874;
    }
  }
...
L_8005A834:;
  ...
  {
    int _t = (c->r[3] == c->r[2]);
    c->r[2] = (uint32_t)((int32_t)c->r[3] < 15);
    if (_t) {
      goto L_8005A8B4;
    }
  }
...
L_80062E40:;
  ...
  c->r[3] = c->r[3] + c->r[2];
  c->r[31] = 0x80062EC0u;
  c->mem_w16((c->r[16] + (uint32_t)46), (uint16_t)c->r[3]);
  func_80083E80(c);
  c->r[2] = c->r[2] << 3;
  c->r[2] = (uint32_t)((int32_t)c->r[2] >> 12);
  c->r[3] = (uint32_t)c->mem_r16((c->r[16] + (uint32_t)54));
  ...
  {
    int _t = ((int32_t)c->r[4] < 0);
    c->mem_w16((c->r[16] + (uint32_t)54), (uint16_t)c->r[3]);
    if (_t) {
      goto L_80062EE0;
    }
  }
...
L_80062EF4:;
  ...
  c->r[2] = c->r[2] & 3u;
  c->r[31] = 0x80062F38u;
  c->mem_w8((c->r[16] + (uint32_t)381), (uint8_t)c->r[2]);
  func_80048654(c);
  c->r[2] = (uint32_t)8064u << 16;
  c->r[3] = (uint32_t)8064u << 16;
...
L_80067F2C:;
  ...
  goto L_80067F98;
L_80067F40:;
  c->r[2] = c->r[0] + (uint32_t)266;
  goto L_80067F98;
L_80067F48:;
  c->r[2] = c->r[0] + (uint32_t)65;
  goto L_80067F98;
L_80067F50:;
  c->r[2] = c->r[0] + (uint32_t)1028;
  goto L_80067F98;
L_80067F58:;
  c->r[2] = c->r[0] + (uint32_t)2053;
  goto L_80067F98;
L_80067F60:;
  c->r[2] = c->r[0] + (uint32_t)4102;
  goto L_80067F98;
L_80067F68:;
  c->r[2] = (uint32_t)c->mem_r16((c->r[4] + (uint32_t)382));
  c->r[2] = c->r[2] & 32768u;
  ...
  goto L_80067F98;
L_80067F7C:;
  c->r[2] = c->r[0] + (uint32_t)16392;
  goto L_80067F98;
L_80067F84:;
  c->r[2] = c->r[0] + (uint32_t)34;
  goto L_80067F98;
L_80067F8C:;
  c->r[2] = c->r[0] + (uint32_t)521;
  goto L_80067F98;
L_80067F94:;
...
L_80067FC0:;
  ...
  c->r[4] = c->r[4] + (uint32_t)-12200;
  c->r[31] = 0x80067FD4u;
  c->mem_w16((c->r[3] + (uint32_t)-1890), (uint16_t)c->r[2]);
  func_80024E00(c);
  c->r[31] = c->mem_r32((c->r[29] + (uint32_t)16));
  c->r[29] = c->r[29] + (uint32_t)24;
  return;
...
L_80068360:;
  ...
  c->r[31] = 0x80068370u;
  c->mem_w32((c->r[16] + (uint32_t)116), c->r[0]);
  func_80067DA8(c);
  c->r[31] = 0x80068378u;
  c->r[4] = c->r[16] + c->r[0];
  func_80067EF4(c);
...
L_8006CF88:;
  ...
  c->r[2] = (uint32_t)((int32_t)c->r[2] >> 3);
  c->r[3] = c->r[3] + c->r[2];
  c->mem_w32((c->r[16] + (uint32_t)4), c->r[3]);
  goto L_8006CFA8;
L_8006CFA0:;
...
L_8006CFE8:;
  ...
  c->r[2] = (uint32_t)((int32_t)c->r[2] >> 3);
  c->r[3] = c->r[3] + c->r[2];
  c->mem_w32((c->r[16] + (uint32_t)8), c->r[3]);
  goto L_8006D008;
L_8006D000:;
...
static void leaf_8006F138(Core *c) {
  ...
  {
    int _t = (c->r[5] == c->r[0]);
    c->mem_w32((c->r[18] + (uint32_t)180), c->r[4]);
    if (_t) {
      goto L_8006F2B0;
    }
  }
...
static void leaf_800708B4(Core *c) {
  ...
  c->mem_w8((c->r[2] + (uint32_t)3), (uint8_t)c->r[4]);
  return;
  return;
}
...
static void leaf_800716B4(Core *c) {
  ...
  c->r[31] = 0x800716ECu;
  c->mem_w32((c->r[2] + (uint32_t)532), c->r[16]);
  func_800519E0(c);
  {
    int _t = (c->r[2] != c->r[0]);
    c->r[4] = c->r[16] + c->r[0];
  ...
  c->r[31] = 0x80071744u;
  c->mem_w32((c->r[16] + (uint32_t)60), c->r[3]);
  func_80040CDC(c);
  c->r[2] = (uint32_t)c->mem_r8((c->r[16] + (uint32_t)4));
  c->r[2] = c->r[2] + (uint32_t)1;
  c->mem_w8((c->r[16] + (uint32_t)4), (uint8_t)c->r[2]);
...
L_80074BA4:;
  ...
  c->r[4] = c->r[0] + c->r[0];
  c->r[31] = 0x80074BB4u;
  c->mem_w32((c->r[2] + (uint32_t)-7336), c->r[5]);
  func_80098F90(c);
  c->r[31] = c->mem_r32((c->r[29] + (uint32_t)16));
  c->r[29] = c->r[29] + (uint32_t)24;
  return;
...
L_80074EC0:;
  ...
  c->r[2] = c->r[0] + (uint32_t)-1;
  c->r[31] = 0x80074EDCu;
  c->mem_w16((c->r[3] + (uint32_t)-4736), (uint16_t)c->r[2]);
  func_800963A0(c);
L_80074EDC:;
  c->r[31] = c->mem_r32((c->r[29] + (uint32_t)16));
  c->r[29] = c->r[29] + (uint32_t)24;
...
static void leaf_80075D58(Core *c) {
  ...
  c->r[2] = c->r[2] - c->r[3];
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[5];
    c->lo = (uint32_t)_p;
    c->hi = (uint32_t)((uint64_t)_p >> 32);
  }
  ...
  {
    int _t = (c->r[4] != c->r[0]);
    c->mem_w16((c->r[5] + (uint32_t)-7648), (uint16_t)c->r[3]);
    if (_t) {
      goto L_80075DC8;
    }
  }
  ...
  c->r[31] = 0x80075DC0u;
  c->mem_w8((c->r[2] + (uint32_t)3), (uint8_t)c->r[0]);
  func_80096390(c);
...
L_80075DC8:;
  ...
  c->mem_w8((c->r[2] + (uint32_t)2), (uint8_t)c->r[3]);
  c->r[31] = 0x80075DE8u;
  c->mem_w8((c->r[2] + (uint32_t)3), (uint8_t)c->r[3]);
  func_80096380(c);
  c->r[4] = (uint32_t)32780u << 16;
L_80075DEC:;
  c->r[31] = 0x80075DF4u;
  c->r[4] = c->r[4] + (uint32_t)-4740;
  func_80089F68(c);
  c->r[31] = c->mem_r32((c->r[29] + (uint32_t)16));
  c->r[29] = c->r[29] + (uint32_t)24;
  return;
...
static void leaf_80075FF8(Core *c) {
  ...
  {
    int _t = (c->r[2] == c->r[0]);
    c->mem_w8((c->r[12] + (uint32_t)8), (uint8_t)c->r[3]);
    if (_t) {
      goto L_800764CC;
    }
  }
...
L_80076198:;
  ...
  {
    int _t = (c->r[3] == c->r[0]);
    c->mem_w8((c->r[12] + (uint32_t)8), (uint8_t)c->r[2]);
    if (_t) {
      goto L_800768FC;
    }
  }
...
L_80079400:;
  ...
  {
    int _t = (c->r[2] == c->r[0]);
    c->mem_w32((c->r[18] + (uint32_t)0), c->r[3]);
    if (_t) {
      goto L_80079428;
    }
  }
...
L_8007B10C:;
  ...
  c->r[5] = c->r[0] + c->r[0];
  c->r[31] = 0x8007B11Cu;
  c->r[6] = c->r[0] + (uint32_t)68;
  func_8009A420(c);
  c->r[16] = c->r[16] + (uint32_t)1;
  c->r[2] = (uint32_t)((int32_t)c->r[16] < 520);
  {
    int _t = (c->r[2] != c->r[0]);
    c->r[17] = c->r[17] + (uint32_t)68;
    if (_t) {
      goto L_8007B10C;
    }
  }
...
static void leaf_8007B38C(Core *c) {
  ...
  c->r[31] = 0x8007B3E4u;
  c->mem_w8((c->r[3] + (uint32_t)1501), (uint8_t)c->r[2]);
  func_8007B2C0(c);
  c->r[31] = c->mem_r32((c->r[29] + (uint32_t)16));
  c->r[29] = c->r[29] + (uint32_t)24;
  return;
...
L_8007B540:;
  ...
  c->mem_w8((c->r[4] + (uint32_t)-2040), (uint8_t)c->r[0]);
  goto L_8007BE08;
L_8007B57C:;
  c->r[2] = c->r[3] & 16u;
  {
  ...
  c->mem_w8((c->r[3] + (uint32_t)-2040), (uint8_t)c->r[2]);
  goto L_8007B84C;
L_8007B5A4:;
  {
    int _t = (c->r[2] == c->r[0]);
  ...
  c->mem_w8((c->r[4] + (uint32_t)-2040), (uint8_t)c->r[2]);
  goto L_8007B84C;
L_8007B5C8:;
  c->r[31] = 0x8007B5D0u;
  func_8007F250(c);
...
L_8007B660:;
  ...
  c->mem_w8((c->r[3] + (uint32_t)2), (uint8_t)c->r[2]);
  goto L_8007B84C;
L_8007B67C:;
  c->r[2] = c->r[3] & 128u;
  {
...
L_8007B864:;
  ...
  c->r[2] = c->r[0] + (uint32_t)1;
  c->r[31] = 0x8007B874u;
  c->mem_w8((c->r[16] + (uint32_t)310), (uint8_t)c->r[2]);
  func_8007F73C(c);
  c->r[2] = (uint32_t)32782u << 16;
...
L_8007B8B8:;
  ...
  {
    int _t = ((int32_t)c->r[3] <= 0);
    c->mem_w16((c->r[2] + (uint32_t)96), (uint16_t)c->r[0]);
    if (_t) {
      goto L_8007BE08;
    }
  }
...
L_8007B91C:;
  ...
  {
    int _t = (c->r[2] != c->r[0]);
    c->mem_w16((c->r[3] + (uint32_t)96), (uint16_t)c->r[4]);
    if (_t) {
      goto L_8007BE08;
    }
  }
...
L_8007BC90:;
  ...
  c->r[2] = (uint32_t)c->mem_r8((c->r[16] + (uint32_t)-2040));
  c->r[2] = c->r[2] + (uint32_t)-1;
  c->mem_w8((c->r[16] + (uint32_t)-2040), (uint8_t)c->r[2]);
  goto L_8007BE08;
L_8007BCC0:;
  c->r[2] = c->r[3] & 64u;
  {
...
L_8007BF68:;
  ...
  {
    int _t = (c->r[17] != c->r[0]);
    c->mem_w8((c->r[3] + (uint32_t)66), (uint8_t)c->r[2]);
    if (_t) {
      goto L_8007BF9C;
    }
  }
...
L_8007BFC4:;
  ...
  c->r[3] = (uint32_t)32780u << 16;
  c->r[2] = c->r[0] + (uint32_t)3;
  c->mem_w8((c->r[3] + (uint32_t)-1974), (uint8_t)c->r[2]);
  goto L_8007C0BC;
L_8007C004:;
  c->r[3] = c->r[3] + (uint32_t)-2040;
  c->r[2] = (uint32_t)c->mem_r8((c->r[3] + (uint32_t)66));
...
static void leaf_800455C0(Core *c) {
  ...
  c->r[8] = c->lo;
  c->r[31] = 0x80045614u;
  c->r[16] = (uint32_t)((int32_t)c->r[8] >> 12);
  func_80083F50(c);
  {
    int64_t _p = (int64_t)(int32_t)c->r[2] * (int64_t)(int32_t)c->r[17];
    c->lo = (uint32_t)_p;
  ...
  c->r[2] = c->r[2] + c->r[5];
  c->r[31] = 0x80045658u;
  c->mem_w16((c->r[3] + (uint32_t)444), (uint16_t)c->r[2]);
  func_800498C8(c);
  {
    int _t = (c->r[2] == c->r[0]);
    c->r[2] = c->r[0] + c->r[0];
  ...
  {
    int _t = (c->r[3] == c->r[2]);
    c->r[2] = (uint32_t)((int32_t)c->r[3] < 1537);
    if (_t) {
      goto L_800456E4;
    }
  }
...
L_800456B0:;
  ...
  c->r[4] = c->r[4] + c->r[5];
  c->mem_w16((c->r[19] + (uint32_t)50), (uint16_t)c->r[4]);
  goto L_80045708;
L_800456E4:;
  c->r[2] = c->r[0] + (uint32_t)2;
  goto L_80045708;
L_800456EC:;
  ...
  c->r[2] = c->r[0] + (uint32_t)1;
  c->r[3] = c->r[3] + c->r[4];
  c->mem_w16((c->r[19] + (uint32_t)50), (uint16_t)c->r[3]);
  goto L_80045708;
L_80045704:;
  c->r[2] = c->r[0] + c->r[0];
L_80045708:;
...
static void leaf_8004602C(Core *c) {
  ...
  {
    int _t = (c->r[16] != c->r[0]);
    c->mem_w16((c->r[29] + (uint32_t)24), (uint16_t)c->r[8]);
    if (_t) {
      goto L_8004607C;
    }
  }
...
L_800460D8:;
  ...
  c->r[31] = 0x8004614Cu;
  c->mem_w16((c->r[16] + (uint32_t)446), (uint16_t)c->r[2]);
  func_800462E4(c);
...
L_8004623C:;
  ...
  c->r[2] = c->r[4] - c->r[6];
  c->mem_w16((c->r[3] + (uint32_t)452), (uint16_t)c->r[2]);
  goto L_800462AC;
L_80046294:;
  c->r[2] = (uint32_t)8064u << 16;
...
L_80049210:;
  ...
  c->r[2] = c->r[4] + c->r[0];
  c->r[31] = 0x80049220u;
  c->mem_w8((c->r[10] + (uint32_t)42), (uint8_t)c->r[2]);
  func_80048ECC(c);
  c->r[2] = (uint32_t)8064u << 16;
...
L_8004EAF8:;
  ...
  goto L_8004EB20;
L_8004EB08:;
  c->r[2] = c->r[0] + (uint32_t)244;
  goto L_8004EB1C;
L_8004EB10:;
  c->r[2] = c->r[0] + (uint32_t)242;
  goto L_8004EB1C;
L_8004EB18:;
...
L_8004EB58:;
  c->mem_w8((c->r[4] + (uint32_t)0), (uint8_t)c->r[6]);
  goto L_8004EB64;
L_8004EB60:;
  c->mem_w8((c->r[4] + (uint32_t)0), (uint8_t)c->r[2]);
L_8004EB64:;
...
static void leaf_8004F184(Core *c) {
  ...
  {
    int _t = (c->r[4] != c->r[0]);
    c->mem_w16((c->r[29] + (uint32_t)64), (uint16_t)c->r[0]);
    if (_t) {
      goto L_8004F2A4;
    }
  }
  ...
  c->r[6] = c->r[0] + (uint32_t)2;
  c->r[31] = 0x8004F1FCu;
  c->mem_w8((c->r[16] + (uint32_t)9), (uint8_t)c->r[0]);
  func_8004F058(c);
  c->r[4] = c->r[2] + c->r[0];
  c->r[2] = c->r[4] << 16;
  {
...
L_80057284:;
  ...
  c->r[5] = (uint32_t)(int16_t)c->mem_r16((c->r[16] + (uint32_t)88));
  c->r[31] = 0x800572ACu;
  c->r[6] = c->r[0] + (uint32_t)32;
  func_800776F8(c);
  c->mem_w16((c->r[16] + (uint32_t)88), (uint16_t)c->r[2]);
L_800572B0:;
  c->r[2] = c->r[0] + (uint32_t)6656;
  goto L_800572D8;
L_800572B8:;
  {
    int _t = (c->r[17] == c->r[2]);
...
L_80072194:;
  ...
  {
    int _t = (c->r[2] != c->r[0]);
    c->mem_w32((c->r[4] + (uint32_t)52), c->r[16]);
    if (_t) {
      goto L_800721BC;
    }
  }
...
L_80045780:;
  ...
  {
    int _t = (c->r[2] == c->r[0]);
    c->r[4] = (uint32_t)((int32_t)c->r[20] >> 16);
    if (_t) {
      goto L_800457B8;
    }
  }
...
static void leaf_800462E4(Core *c) {
  ...
  c->r[8] = c->r[3] + c->r[2];
  c->r[2] = (uint32_t)8064u << 16;
  c->mem_w16((c->r[2] + (uint32_t)420), (uint16_t)c->r[3]);
  goto L_80046330;
L_80046320:;
...
L_80046330:;
  ...
  c->r[3] = (uint32_t)c->mem_r16((c->r[5] + (uint32_t)2));
  c->r[12] = c->lo;
  c->r[2] = (uint32_t)((int32_t)c->r[12] >> 6);
  goto L_8004641C;
L_800463C4:;
  c->r[3] = c->r[10] << 16;
  c->r[3] = (uint32_t)((int32_t)c->r[3] >> 16);
...
L_8004661C:;
  ...
  c->r[2] = c->r[10] + c->r[2];
  c->mem_w16((c->r[3] + (uint32_t)454), (uint16_t)c->r[2]);
  goto L_80046718;
L_80046660:;
  c->r[2] = (uint32_t)8064u << 16;
  c->r[5] = c->r[10] ^ 63u;
...
L_8004681C:;
  ...
  c->mem_w16((c->r[2] + (uint32_t)450), (uint16_t)c->r[3]);
  c->r[2] = (uint32_t)8064u << 16;
  c->mem_w16((c->r[2] + (uint32_t)454), (uint16_t)c->r[11]);
  goto L_80046874;
L_80046838:;
  c->r[2] = (uint32_t)8064u << 16;
  c->r[2] = c->mem_r32((c->r[2] + (uint32_t)480));
  ...
  c->r[2] = (uint32_t)8064u << 16;
  c->mem_w16((c->r[2] + (uint32_t)454), (uint16_t)c->r[10]);
  goto L_80046874;
L_80046868:;
...
L_80049854:;
  ...
  c->r[31] = 0x80049878u;
  c->r[4] = (uint32_t)((int32_t)c->r[19] >> 16);
  func_800459D0(c);
  c->r[3] = c->r[2] + c->r[0];
  c->r[2] = c->r[0] + (uint32_t)-1;
  {
...
void register_field_owned_leaves() {
  ...
  // (portmap render-producer-effect-mesh / render-producer-charge-starburst) — do NOT re-register a
  // transcription here to fill the gap; the fix is a native producer driven by each controller's own
  // node state.
