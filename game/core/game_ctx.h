...
static inline Engine &eng(Core *c) {
  return gctx(c)->engine;
}
static inline ScreenFade &fade(Core *c) {
  return gctx(c)->screenFade;
}
static inline Rng &rngOf(Core *c) {
  return gctx(c)->rng;
}
static inline Trig &trigOf(Core *c) {
  return gctx(c)->trig;
}
static inline Math &mathOf(Core *c) {
  return gctx(c)->math;
}
static inline Mtx &mtxOf(Core *c) {
  return gctx(c)->mtx;
}
static inline Inventory &inv(Core *c) {
  return gctx(c)->inventory;
}
static inline SaveMenu &saveMenuOf(Core *c) {
  return gctx(c)->saveMenu;
}
static inline Render *rend(Core *c) {
  return gctx(c)->mRender;
}
