...
L_800252D0:;
  ...
  goto L_80025578;
L_800252FC:;
  c->mem_w8((c->r[4] + (uint32_t)8), (uint8_t)c->r[3]);
  goto L_8002535C;
L_80025304:;
...
namespace {
void ov_fieldTargetCursor(Core *c) {
  eng(c).fieldTargetCursor();
}
} // namespace
void Engine::registerFieldTargetCursor() {
  overrides::install(
      0x800251F0u, "Engine::fieldTargetCursor", ov_fieldTargetCursor, gen_func_800251F0, shard_set_override);
}
