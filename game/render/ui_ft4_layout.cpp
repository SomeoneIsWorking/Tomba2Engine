...
void UiFt4Layout::xMirroredQuadVerts(Core* c) {
    ...
    c->r[2] = c->r[2] + (uint32_t)-1;
    c->mem_w8((c->r[8] + (uint32_t)36), (uint8_t)c->r[2]); func_8007E620(c); return;
    return;
}
...
void UiFt4Layout::vMirroredQuadVerts(Core* c) {
    ...
    c->r[2] = c->r[2] + (uint32_t)-1; goto L_8007E618;
    return;
  L_8007E204:;
    ...
    { int _t = (c->r[15] == c->r[0]); c->mem_w16((c->r[8] + (uint32_t)36), (uint16_t)c->r[3]); if (_t) goto L_8007E244; }
    c->r[2] = c->r[0] + (uint32_t)46;
    c->mem_w8((c->r[8] + (uint32_t)7), (uint8_t)c->r[2]);
  L_8007E244:;
    { int _t = (c->r[10] == c->r[0]);  if (_t) goto L_8007E25C; }
    c->mem_w8((c->r[8] + (uint32_t)6), (uint8_t)c->r[10]);
    c->mem_w8((c->r[8] + (uint32_t)5), (uint8_t)c->r[10]);
    c->mem_w8((c->r[8] + (uint32_t)4), (uint8_t)c->r[10]); goto L_8007E26C;
  L_8007E25C:;
    c->r[2] = (uint32_t)c->mem_r8((c->r[8] + (uint32_t)7));
    c->r[2] = c->r[2] | 1u;
    c->mem_w8((c->r[8] + (uint32_t)7), (uint8_t)c->r[2]);
  L_8007E26C:;
    { int _t = (c->r[24] == c->r[0]);  if (_t) goto L_8007E280; }
  ...
  L_8007E280:;
    ...
    { int _t = ((int32_t)c->r[2] > 0); c->r[6] = c->r[3] + c->r[0]; if (_t) goto L_8007E2A8; }
    { int _t = ((int32_t)c->r[2] >= 0);  if (_t) goto L_8007E2A4; }
    c->r[2] = (uint32_t)c->mem_r8((c->r[9] + (uint32_t)-5));
    c->r[6] = c->r[2] + c->r[3]; goto L_8007E2A8;
  L_8007E2A4:;
  ...
  L_8007E2A8:;
    ...
    { int _t = ((int32_t)c->r[2] > 0); c->r[5] = c->r[3] + c->r[0]; if (_t) goto L_8007E2D0; }
    { int _t = ((int32_t)c->r[2] >= 0);  if (_t) goto L_8007E2CC; }
    c->r[2] = (uint32_t)c->mem_r8((c->r[9] + (uint32_t)-4));
    c->r[5] = c->r[2] + c->r[3]; goto L_8007E2D0;
  L_8007E2CC:;
    c->r[5] = (uint32_t)c->mem_r8((c->r[9] + (uint32_t)-4));
  L_8007E2D0:;
    c->r[3] = (uint32_t)c->mem_r8((c->r[13] + (uint32_t)0));
    c->r[2] = (uint32_t)(c->r[3] < (uint32_t)6);
    { int _t = (c->r[2] == c->r[0]); c->r[2] = c->r[3] << 2; if (_t) goto L_8007E620; }
    c->r[2] = c->r[2] + c->r[25];
  ...
  L_8007E620:;
    ...
    c->mem_w32((c->r[4] + (uint32_t)0), c->r[2]);
    c->r[4] = c->r[4] + (uint32_t)4;
    { int _t = (c->r[14] != c->r[0]); c->mem_w32((c->r[6] + (uint32_t)-2748), c->r[4]); if (_t) goto L_8007E204; }
     return;
    return;
}
...
void UiFt4Layout::flipXYQuadVerts(Core* c) {
    ...
    c->r[2] = (uint32_t)c->mem_r8((c->r[8] + (uint32_t)37));
    c->r[2] = c->r[2] + (uint32_t)-1;
    c->mem_w8((c->r[8] + (uint32_t)37), (uint8_t)c->r[2]); func_8007E620(c); return;
    return;
}
