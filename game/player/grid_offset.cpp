...
static inline uint32_t mlo(int32_t a, int32_t b) {
  return (uint32_t)((uint64_t)(int64_t)a * (int64_t)b);
}
...
static uint32_t grid_offset_48360(Core *c) {
  ...
  if (q == 1 || q == 3) {
    c->mem_w16(SP + 0x1C6, (uint16_t)(a0 ^ 0x3Fu));
  }
  if (q == 2 || q == 3) {
    c->mem_w16(SP + 0x1C2, (uint16_t)(a1 ^ 0x3Fu));
  }
  ...
  if (q == 2 || q == 3) {
    c->mem_w16(SP + 0x1C2, (uint16_t)(ox ^ 0x3Fu));
  }
  if (q == 1 || q == 3) {
    c->mem_w16(SP + 0x1C6, (uint16_t)(oz ^ 0x3Fu));
  }
