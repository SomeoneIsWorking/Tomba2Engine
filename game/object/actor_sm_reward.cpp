...
// Guest-stack spill tables — generated by `tools/abi_extract.py <addr> --scaffold --guestabi`,
...
void ActorReward::smEventDispatch(Core *c) {
  ...
  case 0x56: {
    c->r[R_A0] = 0x4d;
    c->r[R_A1] = 2;
    rec_dispatch(c, FN_D4F4);
    c->r[R_A0] = 0x57;
    c->r[R_A1] = 2;
    rec_dispatch(c, FN_ED0C);
    c->r[R_A0] = 0x3e;
    c->r[31] = 0x8004A548u;
    rec_dispatch(c, FN_40B48);
    break;
  ...
  case 0x89: {
    ...
    c->r[R_A0] = 0x50;
    c->r[31] = 0x8004A6D4u;
    rec_dispatch(c, FN_40B48); // shared tail L_8004A6CC
    break;
  }
  case 0x90: {
...
void ActorReward::update(Core *c) {
      ...
      if ((c->mem_r8(obj + 0x5f) & 1) != 0) {
        if ((c->mem_r8(obj + 0x5f) & 2) != 0) {
          ...
          case 0xf:
            c->r[R_A0] = obj;
            c->r[31] = 0x80070254u;
            rec_dispatch(c, FN_A118);
            result = c->r[R_V0];
            break;
          case 0x10:
            c->r[R_A0] = obj;
            c->r[31] = 0x80070264u;
            rec_dispatch(c, FN_A2A0);
            result = c->r[R_V0];
            break;
          case 0x11:
            c->r[R_A0] = obj;
            c->r[31] = 0x80070274u;
            rec_dispatch(c, FN_B428);
            result = c->r[R_V0];
            break;
          default:
            break;
  ...
  if ((flags5f & 0x80) == 0) {
    c->r[R_A0] = obj;
    c->r[31] = 0x80070168u;
    rec_dispatch(c, FN_517F8); // GraphicsBind::renderUpdateBody
  } else {
    c->r[R_A0] = obj;
    c->r[31] = 0x80070158u;
    rec_dispatch(c, FN_77B5C); // Animation::advanceLinkChain
  }
  updateEpilogue(c);
}
...
void ActorReward::registerOverrides(Game * /*game*/) {
  ...
  install(
      0x80049A60u, "ActorReward::smWindowScroll", ActorReward::smWindowScroll, gen_func_80049A60, shard_set_override);
  install(0x80049E54u, "ActorReward::smTallyTick", ActorReward::smTallyTick, gen_func_80049E54, shard_set_override);
  install(
      0x8004A3D4u, "ActorReward::smEventDispatch", ActorReward::smEventDispatch, gen_func_8004A3D4, shard_set_override);
  install(0x80070018u, "ActorReward::update", ActorReward::update, gen_func_80070018, shard_set_override);
  install(
      0x800702C0u, "ActorReward::resolvePosition", ActorReward::resolvePosition, gen_func_800702C0, shard_set_override);
  install(
      0x80070650u, "ActorReward::approachTargetX", ActorReward::approachTargetX, gen_func_80070650, shard_set_override);
