  ...
  case 0: {                 // jt1 -> 0x8012db60
    ...
    if (s1 == 0) {          // 0x8012db88
      ...
      (c->r[4] = s0,
       c->r[5] = A1_MODEL,
       c->r[6] = 15,
       eng(c).graphicsBind.setGeom()); // FUN_80077B38(node, 0x8014C808, 15)
  ...
  case 2: {                               // jt1 -> 0x8012dc20
    ...
    if (s1 == 0) {                        // 0x8012dc40
      ...
      (c->r[4] = s0,
       c->r[5] = A1_MODEL,
       c->r[6] = 2,
       eng(c).graphicsBind.setGeom()); // FUN_80077B38(node, 0x8014C808, 2)
  ...
  case 6: { // jt1 -> 0x8012dcb0
    ...
    if (s1 == 0) { // 0x8012dcd0
      ...
      (c->r[4] = s0,
       c->r[5] = A1_MODEL,
       c->r[6] = 17,
       eng(c).graphicsBind.setGeom()); // FUN_80077B38(node, 0x8014C808, 17)
    ...
    c->r[5] = 2;
    c->r[6] = 0;
    c->r[7] = c->mem_r32(rec + 0xD0);
    c->mem_w32(c->r[29] + 16, s0 + 0x60);
    eng(c).graphicsBind.posCompose();      // FUN_8004BD64 — native
    c->mem_w8(s0 + 1, c->mem_r8(rec + 1)); // node[1] = node[0x10][1]
    if (c->mem_r8(0x800BF9B5u) != 5) {
      goto Lret;
    }
  ...
  case 7: { // jt1 -> 0x8012dd4c
    ...
    if (s1 == 0) { // 0x8012dd6c
      ...
      (c->r[4] = s0,
       c->r[5] = A1_MODEL,
       c->r[6] = 14,
       eng(c).graphicsBind.setGeom()); // FUN_80077B38(node, 0x8014C808, 14)
      c->mem_w16(s0 + 0x60, (uint16_t)(int16_t)-200);
