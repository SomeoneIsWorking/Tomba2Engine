...
L3b0:
  ...
  p = c->mem_r32(s0 + 0xC0);
  c->mem_w16(p + 0, c->mem_r16(s1 + 0));
  p = c->mem_r32(s0 + 0xC0);
  c->mem_w16(p + 2, c->mem_r16(s1 + 2));
  p = c->mem_r32(s0 + 0xC0);
  c->mem_w16(p + 4, c->mem_r16(s1 + 4));
  p = c->mem_r32(s0 + 0xC0);
  c->mem_w16(p + 8, 0);
  p = c->mem_r32(s0 + 0xC0);
  c->mem_w16(p + 10, 0);
...
L4ec:
  ...
  if (c->mem_r8(s1 + 362) == 0) {
    goto L520;
  }
L510:
  if (c->mem_r8(s1 + 385) == 0) {
    goto L848;
  }
  goto L520;
L520:
...
L618:
  ...
  v1 = c->mem_r32(obj + 0xC4);
  c->mem_w16(v1 + 10, c->mem_r16(0x1F8001A2u));
  v1 = c->mem_r32(obj + 0xC4);
  c->mem_w16(v1 + 12, 512);
  c->mem_w8(obj + 1, 2);
  goto L6cc;
...
L6cc:
  ...
  c->mem_w16(v1 + 8, 512);
  v1 = c->mem_r32(obj + 0xC0);
  c->mem_w16(v1 + 10, c->mem_r16(s1 + 320));
  goto L724;
L708:
  v1 = c->mem_r32(obj + 0xC0);
  c->mem_w16(v1 + 8, v0); // v0 = 3584
  v0 = c->mem_r16(s1 + 320);
  v1 = c->mem_r32(obj + 0xC0);
  v0 = v0 + 2048;
  c->mem_w16(v1 + 10, v0);
L724:
  ...
  {
    uint32_t a = c->mem_r32(obj + 0xC0);
    c->mem_w16(a + 2, c->mem_r16(v1 + 2));
  }
  {
    uint32_t a = c->mem_r32(obj + 0xC4);
    c->mem_w16(a + 2, c->mem_r16(v1 + 10));
  }
  goto L784;
L760:
...
L7cc:
  ...
  v0 = eng(c).spawn.spawnOverlayVariant((uint16_t)(uint32_t)((int32_t)c->mem_r8(obj + 1) - 1),
                                        0); // FUN_8007E038 (native)
...
L950:
  ...
  goto L9ac;
L958:
  if (c->mem_r8(obj + 0x46) == s0) {
    goto L9ac; // same child id → keep it
  }
  c->mem_w8(v1 + 4, 3);
  goto L950;
L970:
