...
void beh_sine_motion_sfx(Core *c) {
  ...
  s2 = 1;
  if (v1 == s2) {
    goto L62c; // beq v1,s2,0x8013622c
  }
  v0 = (v1 < 2); // slti v0,v1,2
  if (v0 == 0) {
    goto L19c; // beq v0,zero,0x8013619c
  }
  if (v1 == 0) {
    a0 = (int32_t)nd;
    goto L1b0;
  } // beq v1,zero,0x801361b0 ; delay a0=node
  goto Lret; // j 0x801365a8

L19c:
  v0 = (v1 < 4); // slti v0,v1,4
  if (v0 == 0) {
    goto Lret; // beq v0,zero,0x801365a8
  }
...
L1b0: // ===== STATE 0 (INIT) =====
  ...
  v0 = (int32_t)c->r[2];
  if (v0 != 0) {
    goto Lret; // bne v0,zero,0x801365a8 ; delay v0=576
  }
  v0 = 576;
  a0 = (int32_t)nd;
...
L62c:                              // ===== STATE 1 =====
  ...
  if (v1 < 0) {
    goto Lret; // bltz (dead: lbu>=0) — faithful
  }
  v0 = (v1 < 2); // slti v0,v1,2
  if (v0 != 0) {
    goto L258; // bne v0,zero,0x80136258
  }
  if (v1 == 2) {
    goto L2b4; // beq v1,2,0x801362b4
  }
  goto Lret; // node[5] >= 3
...
L284:
  if (v0 != 0) {
    goto Lret; // bne v0,zero,0x801365a8
  }
  c->mem_w16(nd + 0x44, 0);
...
L2b4: {                                 // inner C (MATH block)
  ...
  if (v0 != 0) {
    goto L48c; // bne v0,zero,0x8013648c
  }
...
L38c: {
  ...
  if (!ltm1024) {
    goto L3e4; // beq v0,zero(>=-1024),0x801363e4
  }
  // v1 < -1024:
