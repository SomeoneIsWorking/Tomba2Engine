...
L_80132BFC:;
  ...
  {
    int _t = (c->r[3] == c->r[0]);
    c->mem_w8((c->r[16] + (uint32_t)95), (uint8_t)c->r[2]);
    if (_t) {
      goto L_80132C20;
    }
  }
...
L_80132C90:;
  ...
  {
    int _t = ((int32_t)c->r[2] > 0);
    c->r[2] = (uint32_t)((int32_t)c->r[2] < 161);
    if (_t) {
      goto L_80132CC4;
    }
  }
...
L_80132CE8:;
  ...
  {
    int _t = (c->r[2] == c->r[0]);
    c->mem_w16((c->r[16] + (uint32_t)76), (uint16_t)c->r[3]);
    if (_t) {
      goto L_80132D14;
    }
  }
...
L_80132D14:;
  ...
  {
    int _t = ((int32_t)c->r[2] >= 0);
    c->r[2] = (uint32_t)((int32_t)c->r[2] < -95);
    if (_t) {
      goto L_80132D30;
    }
  }
...
L_80133664:;
  ...
  c->mem_w16((c->r[6] + (uint32_t)64), (uint16_t)c->r[3]);
  return;
L_80133690:;
  c->r[4] = (uint32_t)c->mem_r16((c->r[6] + (uint32_t)102));
...
// tick reads. ORACLE: ov_a00_gen_801332C4
void CullSubstateLeaves::reverseSwingOnCrossing(Core *c) {
  ...
  c->mem_w16((c->r[16] + (uint32_t)104), (uint16_t)c->r[2]);
  goto L_80133310;
L_8013330C:;
