...
void beh_jumptable_release_trigger(Core *c) {
  ...
  if (st != 1) {
    ...
    if (st != 0) {
      return; // 80124EA8 beqz v1 -> state 0; else dead-fallthrough epilogue
    }
  ...
  // ============================================================================================
  {
    ...
    if (n3 >= 7) {
      goto epi_done; // 80124F30 sltiu v0,v1,7 ; 80124F34 beqz -> 0x801251e8
    }
    ...
    case 1: { // jt[1] = 0x80124f68
      ...
      if (v != 1) {
        goto epi_done; // 80124F94 bne v1,1 -> 0x801251e8
      }
    ...
    case 6: {                          // jt[6] = 0x80125174 : node[6] sub-switch
      ...
      if (n6 == 0) {
        ...
        if (c->mem_r8(0x800BF8BCu) != 0xff) {
          goto epi_done; // 801251A0 bne -> 0x801251e8
        }
