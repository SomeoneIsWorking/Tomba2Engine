...
void cutsceneDirector(Core *c, uint32_t obj) {
  ...
  case 9: {
    ...
    if (s6 == 1) {
      if (c->mem_r8(G_800BFA50) == 0x15u) {
        c->mem_w8(obj + O_SUB_6, 2u);
      }
    } else if (s6 == 0) {
...
int state0Init(Core *c, uint32_t obj) {
  ...
  case 7:
    if ((int8_t)c->mem_r8(G_800BF8E2) != -1) {
      call3(c, obj, 0x0Cu, 0x21u, 0x80051B70u);
      return LAB_none;
    }
    break;
  case 8:
    if ((int8_t)c->mem_r8(G_800BF8E2) != -1) {
      call3(c, obj, 0x0Cu, 0x22u, 0x80051B70u);
      return LAB_none;
    }
    break;
  case 9:
    ...
    call1(c, obj, 0x800517F8u);
    if ((int8_t)c->mem_r8(G_800BF8DF) == -1) {
  ...
  case 0xB:
    ...
    return LAB_none;
  case 0xE:
    if (call3Ret(c, obj, 0x0Cu, 0x2Bu, 0x80051B70u) == 0) {
      return LAB_b88;
    }
    return LAB_none;
  case 0x10:
  ...
  case 0x13:
    if (call3Ret(c, obj, 0x0Cu, 0x6Bu, 0x80051B70u) != 0) {
      return LAB_none;
    }
  ...
  case 0x17:
    if (c->mem_r8(G_800BFA42) == 0) {
      call3(c, obj, 0x0Cu, 0x6Cu, 0x80051B70u);
      return LAB_none;
    }
    break;
  case 0x18:
    ...
    return LAB_none;
  case 0x19:
    call1(c, obj, 0x801279DCu);
    return LAB_none;
  case 0x1A:
    call1(c, obj, 0x80127B34u);
    return LAB_none;
  case 0x1B:
    c->mem_w8(obj + O_KIND, 1u);
...
int state1Run(Core *c, uint32_t obj) {
  ...
  case 5:
    ...
    return RET_bc0;
  case 6:
    call1(c, obj, 0x80126AD8u);
    return RET_none;
  case 7:
    call1(c, obj, 0x80126C68u);
    return RET_none;
  case 8: {
  ...
  case 10:
    call1(c, obj, 0x80126E24u);
    return RET_none;
  case 0xB:
    if (c->mem_r8(G_800BF816) != 0) {
      if (call1Ret(c, obj, 0x8007778Cu) == 0) {
        return RET_none;
      }
      return RET_b88;
    }
  ...
  case 0x16: {
    ...
    if (s5 == 1) {
      ...
      const int32_t sum32 =
          (int32_t)c->mem_r32(c->mem_r32(d10 + O_D_D0) + 0x30u) + (int32_t)c->mem_r32(c->mem_r32(d10 + O_D_DC) + 0x30u);
      c->mem_w16(obj + O_H_32, (uint16_t)((sum32 / 2) - 0x28));
      const int32_t sum36 =
          (int32_t)c->mem_r32(c->mem_r32(d10 + O_D_D0) + 0x34u) + (int32_t)c->mem_r32(c->mem_r32(d10 + O_D_DC) + 0x34u);
  ...
  case 0x18: {
    ...
    if (s5 == 0) {
      if ((c->mem_r8(G_800BFA3F) & 0x80u) == 0) {
        ...
        if (s80 != 0) {
          c->mem_w16(obj + O_H_80, (uint16_t)((s80 - 1) - (s80 >> 2)));
        }
      } else {
        c->mem_w8(obj + O_SUB_5, 1u);
      }
  ...
  case 0x19: {
    if ((int8_t)c->mem_r8(G_800BF922) != -1) {
      return RET_none;
    }
    const uint8_t s5 = c->mem_r8(obj + O_SUB_5);
    if (s5 == 1) {
