...
static constexpr GuestFrameSpill kSpills_80132400[3] = {
    {16, 16},
    {31 /*ra*/, 24},
    {17, 20},
...
void beh_single_child_cull(Core *c) {
  GuestFrame<32, 3> frame(c, kSpills_80132400);
...
S0: {
  ...
  c->r[5] = 12;
  c->r[6] = 37;
  eng(c).graphicsBind.recordInit(); // FUN_80051B70(node,12,37) -> bail if !=0
  if (c->r[2] != 0) {
    goto Lret;
  }
